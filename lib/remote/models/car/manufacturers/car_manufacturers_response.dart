...
//
//     final carManufacturersResponse = carManufacturersResponseFromJson(jsonString);

import 'dart:convert';

CarManufacturersResponse carManufacturersResponseFromJson(String str) =>
    CarManufacturersResponse.fromJson(json.decode(str));

String carManufacturersResponseToJson(CarManufacturersResponse data) =>
    json.encode(data.toJson());

class CarManufacturersResponse {
  int? count;
  String? message;
  ...
  factory CarManufacturersResponse.fromJson(Map<String, dynamic> json) =>
      CarManufacturersResponse(
        count: json["Count"],
